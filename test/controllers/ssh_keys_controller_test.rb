...
class SshKeysControllerTest < ActionController::TestCase
  ...
  test "should create ssh_key" do
    assert_difference('SshKey.count') do
      post :create, ssh_key: { key_string: @ssh_key.key_string, name: @ssh_key.name, user_id: @ssh_key.user_id }
    end
  ...
  test "should update ssh_key" do
    patch :update, id: @ssh_key, ssh_key: { key_string: @ssh_key.key_string, name: @ssh_key.name, user_id: @ssh_key.user_id }
    assert_redirected_to ssh_key_path(assigns(:ssh_key))
  end
